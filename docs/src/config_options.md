...
| <span id="AUTOCONNECT__MEGAPHONE_API_TOKEN" />megaphone_api_token | AUTOCONNECT__MEGAPHONE_API_TOKEN | string | _None_ | Token for authentication with the Remote Settings "Megaphone" API server |
...
| <span id="AUTOEND__STATSD_PORT" />statsd_port | AUTOEND__STATSD_PORT | port | 8125 | Port for the statsd collector host |
