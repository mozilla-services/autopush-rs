...
| megaphone_api_token | AUTOCONNECT__MEGAPHONE_API_TOKEN | string | _None_ | Access token for the Megaphone API server |
| megaphone_api_url | AUTOCONNECT__MEGAPHONE_API_URL | string | _None_ | URL to the Megaphone API server |
| megaphone_poll_interval | AUTOCONNECT__MEGAPHONE_POLL_INTERVAL | string | _None_ | URL to the Megaphone API server |
...
| port | AUTOCONNECT__PORT |num | 8080 | The application port to list on |
