...
*PLEASE NOTE* Autopush only used Bigtable in production. Any other datastore is considered experimental and has only been used in small, test environments. Please use caution if you decide to use an alternative data storage system. As always, you're improvements and suggestions are welcome.
