...
META_FAMILY=${ROUTER_FAMILY:-"meta"}
...
cbt -project $PROJECT -instance $INSTANCE createfamily $TABLE_NAME $META_FAMILY
...
cbt -project $PROJECT -instance $INSTANCE setgcpolicy $TABLE_NAME $META_FAMILY maxversions=1
